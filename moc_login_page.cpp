...
QT_MOC_LITERAL(4, 58, 23) // "on_pushButton_2_clicked"
    ...
    "Login_page\0on_pushButton_clicked\0\0"
...
void Login_page::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Login_page *_t = static_cast<Login_page *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Login_page::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Login_page.data,
      qt_meta_data_Login_page,  qt_static_metacall, nullptr, nullptr}
};
...
void *Login_page::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Login_page.stringdata0))
        return static_cast<void*>(const_cast< Login_page*>(this));
